...
function pageBanner($args = NULL) {
    ...
    if (!$args['photo']) {
        if (get_field('page_banner_image')) {
            ...
            $args['photo'] = get_theme_file_uri('/images/hogwarts-school.jpg');
        }
    }
...
function university_files() {
    wp_enqueue_script('main_university_js', get_theme_file_uri('/js/scripts-bundled.js'), array('jquery'), '1.0', true);
